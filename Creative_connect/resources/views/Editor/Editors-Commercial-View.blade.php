            ...
            <div class="row">
              ...
              <div class="col-lg-4 col-md-4 col-sm-12">
                  <div class="card-tools float-md-right float-sm-none ml-md-0 mr-0 ml-sm-0 mt-sm-1 float-none ml-xs-0 mt-1">
                      <a class="btn btn-xs float-left align-middle mt-0 mr-2 py-1 px-2 mb-1" href="{{route('CommercialEditor')}}" style="position: relative; top: 2px;">Add New Commercial</a>
                  </div>
              </div>
            </div>
          </div>
            ...
            <table id="commTableCat" class="table table-head-fixed table-hover text-nowrap data-table">
              ...
              <tbody>
                ...
                <tr class="wrc-tt">
                  ...
                  <td class="p-sm-2 p-1"><i class="fas fa-rupee-sign"></i>{{$comer->CommercialPerImage}} </td>   
                  <td>
                   <a class="btn btn-warning px-1 py-1 btn-xs mt-1" href="{{ route('EditCommercialEditor', [$comer->id])}}">Edit</a>  
                   {{-- <a class="btn btn-warning px-1 py-1 btn-xs mt-1" href="{{ url('Commercial-Editor/' . $comer->id)}}">Edit</a>   --}}
                  </td>               
                </tr>
                @endforeach
              </tbody>
