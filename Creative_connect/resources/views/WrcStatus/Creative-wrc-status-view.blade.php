                        ...
                        <table id="wrcTable" class="table table-head-fixed table-hover text-nowrap data-table">
                            ...
                            <tbody>
                                ...
                                <tr class="">
                                    ...
                                    <td id="orderQuantity" class="p-sm-2 p-1">{{$wrc->order_qty == 0 ? '-' : $wrc->order_qty}}</td>
                                    <td id="skuQuantity{{$index}}" class="p-sm-2 p-1">{{$wrc->sku_count == 0 ? '-' : $wrc->sku_count}}</td>
                                    <td id="lotNum" class="p-sm-2 p-1">{{$wrc->wrc_status}}</td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
