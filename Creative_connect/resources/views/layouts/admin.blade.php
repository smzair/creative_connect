...
<body class="sidebar-mini layout-fixed accent-yellow " id="main-bdy" style="height: auto;">
    ...
    <div class="wrapper" id="">
        ...
        <aside class="main-sidebar elevation-4 sidebar-light-warning sidebar-no-expand dam-sidebar">
            ...
            <div
                ...
                {{-- <div class="os-content-glue" style="margin: 0px -8px; width: 73px;"></div> --}}
    ...
    <div class="fixed-search-wrapper">
        ...
        <div class="input-group input-group-sm hdr-search-wrapper">
            <input class="form-control form-control-navbar hdr-search" type="search" placeholder="Enter"
                aria-label="Search">
    ...
    <script type="text/javascript" src="{{ asset('js/creativeCommon.js') }}"></script>
