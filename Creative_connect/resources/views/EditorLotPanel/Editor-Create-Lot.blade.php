            ...
            <div class="card card-transparent m-0">
                  <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="card-tools float-md-right float-sm-none ml-md-0 mr-0 ml-sm-0 mt-sm-1 float-none ml-xs-0 mt-2">
                      <a href="{{ route('get_editor_lot_data') }}" class="btn btn-xs float-left align-middle mt-0 mr-2 py-1 px-2 mb-2 mb-sm-1" style="position: relative; top: 2px;">Editor Lot List</a>
                    </div>
                  </div>
                <div class="card-body">
                    <!-- New Create Lot -->
                    <form method="POST" id = "form" action="{{ route($EditorLots->route) }}" onsubmit="return validateForm(event)">
                        ...
                        @csrf
                            ...
                            <div class="col-sm-4 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="request_name" id="request_name" placeholder="Enter Request Name">
                                </div>
                                <p class="input_err" style="color: red; display: none;" id="request_name_err"></p>
                            </div>
                           
                        <div class="row custom-select-row">
                            <div class="col-sm-12 mb-3">
                                   <button type="submit" class="btn btn-sm btn-warning md-2" >{{$EditorLots->button_name}}</button>
                            </div>
                        </div>
                    </form>
                </div>
