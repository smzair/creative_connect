        ...
        <div class="col-3">
            <div class="card card-transparent card-info mt-3">
                ...
                <div class="card-header">
                    <h2 class="card-title" > Upload Editing Wrc Invoice Numbers</h2>
                ...
                <div class="card-body">
                    <div class="row" style="width: 100%">
                        <form method="POST"  action="{{route('SaveEditingBulkInvoice')}}" enctype="multipart/form-data" style="width: 100%" >
                            @csrf
                            <div class="col-12">
                                <div class="box">
                                    {{-- <label class="control-label  required" style="display: block">Upload Editing Wrc Invoice Numbers</label> --}}
        ...
        <div class="col-12">
            <div class="card card-transparent">
                ...
                <div class="card-header">
                    <div class="row">
                        <div class="col-6">
                            <h3 class="card-title" style="font-size: 2rem;">Update Editing Invoice Number</h3>
                        </div>
                        <div class="col-6">
                            <a  class="btn btn-warning" id="uploadPlanSkuCsv" onclick="displayRow()">Upload SKU CSV to Plan</a>
                            <a download="Editing Invoice Number CSV" href="{{ asset('files/editingInvoiceNumber.csv') }}" class="btn btn-warning" id="downloadPlanSkuCsv">Download CSV</a>
                        </div>
                    </div>
                </div>
                        ...
                        <tbody>
                            ...
                            @foreach($Editing_Wrc_list_for_Invoice  as $row_key => $row)
                                @php
                                    ...
                                    $imgqty = $row['imgqty'];
                                    $CommercialPerImage = $row['CommercialPerImage'];
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">{{ $CommercialPerImage }}</td>
                                    <td class="text-center">{{ $imgqty*$CommercialPerImage }}</td>
                                    <td class="text-center" id="invoiceNumber_{{ $submission_id }}">{{ $invoice_number }}</td>
                                    <td>
                    ...
                    <form method="POST" action="comment-form">
                        ...
                        <div class="row" >
                            <div class="col-12 form-group">
                                <textarea type="text" class="form-control" name="invoice_number" id="invoice_number" value=""> </textarea>
...
<script>
    function submit_invoice_number(){
       ...
       let old_invoicenumber =  document.getElementById("invoiceNumber_"+submission_id).innerHTML
        ...
        $.ajax({
            url: "{{ url('save-Editing-invoice-number')}}",
            type: "POST",
            dataType: 'json',
            data: {
                wrc_id,
            ...
            success: function(res) {
                ...
                if(update_status == 1){
                    // alert(massage);
                    document.getElementById("invoiceNumber_"+submission_id).innerHTML = invoice_number
